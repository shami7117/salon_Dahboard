...
const FinanceModal = dynamic(() =>
    import("../../components/Order/OrderModal.js")
);
...
const Index = () => {
    ...
    const columns = [
        ...
        },
        {
            title: (
                <div className="flex items-center space-x-4">
                    <span className="text-base font-lato font-medium">SPA</span>
                </div>
            ),
        ...
        },
        {
            title: (
                <div className="flex items-center space-x-4">
                    <span className="text-base font-lato font-medium">Total Earning</span>
                </div>
            ),
        ...
        },
        {
            title: (
                <div className="flex items-center space-x-4">
                    <span className="text-base font-lato font-medium">SPA Earning</span>
                </div>
            ),
            dataIndex: "end_date",
            sorter: (a, b) => a.age - b.age,
        ...
        },
        {
            title: (
                <div className="flex items-center space-x-4">
                    <span className="text-base font-lato font-medium">Commission</span>
                </div>
            ),
            dataIndex: "end_date",
            sorter: (a, b) => a.age - b.age,
    ...
    return (
        <div>
            ...
            <h2 className="text-2xl font-lato font-medium">Finance</h2>
                    ...
                    return <div className="bg-[#FBEFEF] flex flex-col items-between justify-center md:hidden p-5 rounded-[10px] ">
                        ...
                        <div className="flex py-2 border-b-solid text-[#777777] border-b-[1px] border-b-[#ffffff] justify-between items-center">
                            <h6 className="text-[12px]">
                                SPA<br /><p className="text-[#000000] ">Salon</p>
                            </h6>
                            <h6>
                                Total Earning<br /><p className="text-[#000000]">32424</p>
                            </h6>
                            {/* <h6>
                        ...
                        <div className="flex py-2 border-b-solid border-b-[1px]  border-b-[#ffffff] justify-between items-center text-[#777777]">
                            <h6>
                                SPA Earning<br /><p className="text-[#000000]">123</p>
                            </h6>

                            <h6>
                                Commission<br /><p className="text-[#000000]">332</p>
                            </h6>
                        </div>
                        {/* 2nd end */}
